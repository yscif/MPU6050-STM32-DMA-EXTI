...
void MPU6050_GetGyroscopeRAW(int16_t *gyroRaw);

void MPU6050_GetAllScalled(float (*mpu)[3]);
void MPU6050_GetAllScalled();
...
void MPU6050_Madgwick(float *roll, float *pitch, float *yaw, const float invSampleFreq);
